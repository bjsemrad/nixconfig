...
in {
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      build-lily58 =
        "QMK_HOME=~/vial-qmk qmk compile -kb lily58/rev1 -km brian -e CONVERT_TO=rp2040_ce";
      flash-lily58 =
        "QMK_HOME=~/vial-qmk qmk flash -kb lily58/rev1 -km brian -e CONVERT_TO=rp2040_ce";
      build-ferrismx =
        "QMK_HOME=~/vial-qmk qmk compile -kb ferris/sweep -km mxferris_linvert_blok -e CONVERT_TO=blok";
      flash-ferrismx =
        "QMK_HOME=~/vial-qmk qmk flash -kb ferris/sweep -km mxferris_linvert_blok -e CONVERT_TO=blok";
